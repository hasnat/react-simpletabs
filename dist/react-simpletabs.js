...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabs = React.createClass({
	  ...
	  _getSelectedPanel:function () {
	    ...
	    return (
	      React.createElement("div", {ref: "tabs-holder", className: "tabs-panel"}, 
	        $panels.map(function ($panel, index) {
	          return (
	            React.createElement("article", {ref: (activeIndex == index) ? 'tab-panel' : ('tab-panel-' + index), className: (activeIndex == index) ? 'tab-panel' : 'hidden-tab-panel tab-panel', key: index}, 
	              $panel
	            )
	          );
	        })
